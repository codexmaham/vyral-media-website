...
export default function Process({ ready }: { ready: boolean }) {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      const travel = () => Math.max(0, track.scrollWidth - pin.offsetWidth);

      gsap.set(pin, { zIndex: 1 });
  ...
  return (
    <section ref={sectionRef} id="process" className="relative z-[1] bg-white">
      ...
      <div ref={pinRef} className="process-pin overflow-hidden pb-20 px-6 md:px-10 bg-white">
